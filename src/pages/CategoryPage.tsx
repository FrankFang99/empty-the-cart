      ...
      <main className="pt-20 pb-8 px-4 max-w-7xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-6">
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 rounded-lg bg-white shadow hover:shadow-md transition-all"
          >
            <Filter size={18} />
            筛选
          </button>
        ...
        {category && (
          ...
          >
            {category.subCategories.map((sub) => (
              <button
                key={sub}
                className="px-3 py-1.5 rounded-full bg-white text-sm text-gray-600 hover:bg-purple-100 hover:text-purple-600 transition-colors"
              >
                {sub}
              </button>
            ))}
